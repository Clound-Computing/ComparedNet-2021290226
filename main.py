...
def parse_arguments():
    ...
    parser.add_argument("--pte", type=str, default='',
    ...
    parser.add_argument("--ntags", type=int, default=2)         # 4 or 2
    ...
    if args.mode == 0:
        MODELNAME = 'CompareNet_{}_{}_{}'.format(
            args.pooling.capitalize(), NODETYPE, TIMENOW)
    ...
    args.repeat = len(args.seed) if isinstance(
        args.seed, list) else args.repeat
